...
import { uploadSource } from "../../service/lighthouse/upload";
...
export default function MapRoutes() {
  ...
  //now lets upload the data with lighthouse and make sure that only we have access to it.
  //we can then use the data to create a route on the map.

  const saveRoute = async () => {
    const routeData = formattedRoutes[route];
    const data = routeData.data;
    const routeName = routeData.route;

    const formData = {
      data: data,
      routeName: routeName,
    };
    const hash = (await uploadSource(
      user.address,
      formData,
      routeName,
      "cfapp-route"
    ...
    //once it uploaded we will be changing the hash and submit it towards a routes profile list for the user.
    //now this we will use to make sure that we have this data available at all times for us.
...
const oldRoutes = [
  {
    ...
    data: [
      ...
      { latitude: 37.77447, longitude: -122.430974, timestamp: 1619378320 },
      { latitude: 37.774514, longitude: -122.430887, timestamp: 1619378330 },
      { latitude: 37.774557, longitude: -122.4308, timestamp: 1619378340 },
      { latitude: 37.774603, longitude: -122.43071, timestamp: 1619378350 },
      { latitude: 37.774649, longitude: -122.430623, timestamp: 1619378360 },
      { latitude: 37.774696, longitude: -122.430536, timestamp: 1619378370 },
      { latitude: 37.774738, longitude: -122.43045, timestamp: 1619378380 },
  ...
  },
  {
    ...
    data: [
      ...
      { latitude: 40.74939, longitude: -73.985276, timestamp: 1621644330 },
      { latitude: 40.74958, longitude: -73.985223, timestamp: 1621644340 },
      ...
      { latitude: 40.750533, longitude: -73.98496, timestamp: 1621644390 },
      ...
      { latitude: 40.75244, longitude: -73.984432, timestamp: 1621644490 },
      ...
      { latitude: 40.7553, longitude: -73.983639, timestamp: 1621644640 },
      { latitude: 40.75549, longitude: -73.983586, timestamp: 1621644650 },
      { latitude: 40.755681, longitude: -73.983533, timestamp: 1621644660 },
      { latitude: 40.755872, longitude: -73.98348, timestamp: 1621644670 },
      ...
      { latitude: 40.75816, longitude: -73.982846, timestamp: 1621644790 },
      { latitude: 40.75835, longitude: -73.982793, timestamp: 1621644800 },
    ],
  },
  {
    ...
    data: [
      ...
      { latitude: 22.30897, longitude: 114.168542, timestamp: 1630873820 },
